...
?>';
		...
		$q->execute();
		$q = $conn->prepare("CREATE TABLE applicatioin ( id int(11) NOT NULL, draft_id varchar(20) NOT NULL, applicant int(11) NOT NULL, receiver int(11) NOT NULL, message text NOT NULL, application_date varchar(10) NOT NULL, department varchar(50) NOT NULL, req_date varchar(10) NOT NULL, ending_date varchar(10) NOT NULL, vehicle_req varchar(50) NOT NULL, vehicle_issue varchar(20) NOT NULL, notification varchar(1) NOT NULL, issued_by varchar(20) NOT NULL) ENGINE=InnoDB DEFAULT CHARSET=latin1;");
		$q->execute();
		...
		$q->execute();
		$q = $conn->prepare("ALTER TABLE applicatioin MODIFY id int(11) NOT NULL AUTO_INCREMENT;");
		$q->execute();
